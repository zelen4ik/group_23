...
print('пункт 1', type(var_name), var_name)
print('пункт 2', type(var_age), var_age)
print('пункт 3', type(fl_digit), fl_digit)
print('пункт 4', type(b_type), b_type)
print('пункт 5', type(list_type), list_type)
print('пункт 6', type(tuple_type), tuple_type)
print('пункт 7', type(set_type), set_type)
print('пункт 8', type(fSet), fSet)
print('пункт 9', type(dict_Yura), dict_Yura)
